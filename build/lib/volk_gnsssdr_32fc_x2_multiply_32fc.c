...
/* autogenerated from volk_gnsssdr_32fc_x2_multiply_32fc.orc */
...
#include <orc/orc.h>
#endif
void volk_gnsssdr_32fc_x2_multiply_32fc_a_orc_impl (orc_uint64 * ORC_RESTRICT d1, const orc_uint64 * ORC_RESTRICT s1, const orc_uint64 * ORC_RESTRICT s2, int n);
...
/* volk_gnsssdr_32fc_x2_multiply_32fc_a_orc_impl */
#ifdef DISABLE_ORC
void
volk_gnsssdr_32fc_x2_multiply_32fc_a_orc_impl (orc_uint64 * ORC_RESTRICT d1, const orc_uint64 * ORC_RESTRICT s1, const orc_uint64 * ORC_RESTRICT s2, int n){
  int i;
...
#else
static void
_backup_volk_gnsssdr_32fc_x2_multiply_32fc_a_orc_impl (OrcExecutor * ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
  orc_union64 * ORC_RESTRICT ptr0;
...
volk_gnsssdr_32fc_x2_multiply_32fc_a_orc_impl (orc_uint64 * ORC_RESTRICT d1, const orc_uint64 * ORC_RESTRICT s1, const orc_uint64 * ORC_RESTRICT s2, int n)
{
  ...
  if (!p_inited) {
    ...
    static const orc_uint8 bc[] = {
      1, 9, 45, 118, 111, 108, 107, 95, 103, 110, 115, 115, 115, 100, 114, 95, 
      51, 50, 102, 99, 95, 120, 50, 95, 109, 117, 108, 116, 105, 112, 108, 121, 
      95, 51, 50, 102, 99, 95, 97, 95, 111, 114, 99, 95, 105, 109, 112, 108, 
      11, 8, 8, 12, 8, 8, 12, 8, 8, 20, 8, 20, 4, 20, 4, 20, 
      4, 20, 4, 20, 8, 21, 1, 202, 32, 4, 5, 197, 36, 35, 32, 201, 
      33, 35, 36, 187, 37, 4, 21, 1, 202, 32, 37, 5, 197, 36, 35, 32, 
      200, 34, 35, 36, 194, 0, 33, 34, 2, 0, 
    };
    p = orc_program_new_from_static_bytecode (bc);
    orc_program_set_backup_function (p, _backup_volk_gnsssdr_32fc_x2_multiply_32fc_a_orc_impl);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "volk_gnsssdr_32fc_x2_multiply_32fc_a_orc_impl");
      orc_program_set_backup_function (p, _backup_volk_gnsssdr_32fc_x2_multiply_32fc_a_orc_impl);
